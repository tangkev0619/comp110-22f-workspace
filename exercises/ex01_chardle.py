...
if user_char == user_name[0]:
    print(user_char + " found in index 0")
    counter+=1
if user_char == user_name[1]:
    print(user_char + " found in index 1")
    counter+=1
if user_char == user_name[2]:
    print(user_char + " found in index 2")
    counter+=1
if user_char == user_name[3]:
    print(user_char + " found in index 3")
    counter+=1
if user_char == user_name[4]:
    print(user_char + " found in index 4")
    counter+=1
if counter==0:
    ...
    print("2 instances of " + user_name + " found in " + user_name)