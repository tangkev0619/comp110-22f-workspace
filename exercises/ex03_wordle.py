...
def contains_char(word: str, letter: str) -> bool:
    """This function checks the str of the word and the str of the letter and see if there are any letters in the word."""
    assert len(letter) == 1
    index = 0
...
def input_guess(expectedlen: int) -> str:
    ...
    while len(user_name) != expectedlen:
        user_name = input(f"That wasn't {expectedlen} chars! Try again: ")
    return user_name 
